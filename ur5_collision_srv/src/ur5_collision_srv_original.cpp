/* 
ur5_collision_srv subscribes to /traj_data. The incoming trajectory
...
bool traj_dataCallback(ur5_collision_srv::ur5_collision_srv::Request &req, ur5_collision_srv::ur5_collision_srv::Response &res); 
...
{
  const std::string node_name = "ur5_collision_srv_node";
  ...
  ros::ServiceServer ur5_collision_server = node_handle.advertiseService("ur5_collision_srv", traj_dataCallback);
